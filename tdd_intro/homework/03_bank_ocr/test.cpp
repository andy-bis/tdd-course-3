...
{
    if (display.lines[0] == s_display123456789.lines[0] &&
            display.lines[1] == s_display123456789.lines[1] &&
            display.lines[2] == s_display123456789.lines[2])
    {
        return "123456789";
    }
...
TEST(ParseDisplay, AllDifferent)
{
